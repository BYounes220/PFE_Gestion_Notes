...
SECRET_KEY = 'django-insecure-=z!wt5!+tp-##qv)t6pwcyjjji)9y#j2ef3z1inh3pf(59w+t$'
...
# Set the user ID field to 'user_id' in your custom user model
SIMPLE_JWT = {
...
CORS_ALLOWED_ORIGINS = [
    'http://127.0.0.1:3000',  # React app URL during development
    "http://localhost:3000",
]
...
CSRF_TRUSTED_ORIGINS = CORS_ALLOWED_ORIGINS  # Add this line
