...
SECRET_KEY = 'django-insecure-2-syz@q-fx&%a6=6$s_ls5km+d8g#02n@9iml$a5pqm48*lx*y'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SchoolManagment',  # Your database name
        'USER': 'postgres',
        'PASSWORD': 'yoyo1yo94',
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",  # Example: Localhost API
