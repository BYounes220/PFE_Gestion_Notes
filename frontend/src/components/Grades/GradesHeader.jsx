...
function GradesHeader({ setSearchedEvaluations, evaluations, elementName, showUploadButton }) {
	...
	return (
		<div className="w-full h-24 bg-white/80 backdrop-blur-lg border-b border-gray-200/70 shadow-sm  bg-gradient-to-r from-sky-400 via-orange-400 to-yellow-300 animate-gradient relative overflow-hidden">
			<div className="max-w-7xl mx-auto h-full px-4 flex items-center justify-between">
				...
				<div className="flex items-center space-x-4">
					<button className="px-6 py-2.5 rounded-full bg-orange-500 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center space-x-2 group" onClick={() => navigate("/")}>
