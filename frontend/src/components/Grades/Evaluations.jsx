...
function Evaluations() {
	...
	const handleEdit = (id) => {
		setUpdatedNotes({
			...updatedNotes,
			[id]: {
				note_ordinaire: parseFloat(
					evaluations.find((evaluation) => evaluation.id === id)
						.note_ordinaire
				),
				note_rattrapage: parseFloat(
					evaluations.find((evaluation) => evaluation.id === id)
						.note_rattrapage
				),
			},
	...
	const handleSave = (id) => {
		const updatedEvaluation = evaluations.find(
		...
		api.put(`/Grades/evaluations/${id}/`, updatedData)
			.then((response) => {
